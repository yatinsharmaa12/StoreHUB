  ...
  return (
    <div className="bg-white border border-black/10 rounded-lg overflow-hidden hover:shadow-md transition-shadow">
      ...
      <div className="p-4">
        ...
        <p className="text-black/60 mb-2">{post.Description || "No description available."}</p>
        <div className="flex justify-between items-center">
          <div className="flex space-x-2">
            <span className="bg-black/10 px-2 py-1 rounded text-xs">{post.Framework || "Unknown"}</span>
            <span className="bg-black/10 px-2 py-1 rounded text-xs">{post.ComponentType || "Unknown"}</span>
          </div>
